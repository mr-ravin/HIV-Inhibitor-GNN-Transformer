...
parser = argparse.ArgumentParser(description = "Graph Neural Networks for molecule HIV Activity Classification.")
parser.add_argument('-lr', '--learning_rate', default = 2e-3)
...
def train():
    ...
    train_avg_running_loss = []
    test_avg_running_loss = []
    for epoch in tqdm(range(1, total_epoch+1), desc= "Training Epoch"):
        ...
        if current_avg_test_loss <= max_test_loss:
            ...
            print("Saved weights at epoch: ",epoch)
